...
| | measured | |
|---|---|---|
| API endpoints answered by Rust | **53 of 211** | 25% |
...
`waf` (16 left), `malware` (11), `panel_settings` (8), `users` (5),
...
The shortest honest statement of the distance: **158 of 211 endpoints and

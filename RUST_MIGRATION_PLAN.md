...
| Privileged helper | **deployed** | 83 of the 105 verbs Python calls are answered over the socket |
...
of the 105 verbs the panel's Python calls, 83 are answered over the socket and
22 still fall through to 5,993 lines of bash. Falling through is the design,
...
108 verb names, which is more than the 83 above. Three of those names
...
them, of which 83 are today; the bash helper is no longer
